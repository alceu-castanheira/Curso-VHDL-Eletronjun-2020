...
-- 
-- Este módulo implementa um contador de módulo 6, contando de 0 a 5 para exibir 
...
entity counter_mod6 is
    Port ( 
            ...
            -- Descrição: saída que armazena o valor de contagem de 0 a 5.
            -- OBS: Para contar até 5, só precisamos de 3 bits, mas para
            -- simplificar, como o outro contador tem 4-bits, mantemos essa
            -- saída com 4-bits também.
            --
...
begin
    ...
    -- Processo de contagem de módulo 6: realiza contagem de 0 a 5 a 
    -- cada pulso de subida do clock, reiniciando o processo automaticamente.
    --
    COUNT_MOD6_PROC: process(clk,rst)
    begin
        ...
        --    
            ...
            -- no seu valor limite (5), reiniciar contagem e indicar
            -- que a mesma terminou.
            --
            if s_count = "0101" and enable = '1' then
                s_count <= (others => '0');
                count_end <= '1';
