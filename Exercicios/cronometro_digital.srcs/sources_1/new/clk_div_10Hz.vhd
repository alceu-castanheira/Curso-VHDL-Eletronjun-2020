...
-- Module Name: clk_div_10Hz - Behavioral
...
-- 
-- Este módulo implementa um divisor de clock de 100 MHz (clock da Basys 3) para 10 Hz. 
--
--
-- Dependencies: 
-- 
...
entity clk_div_10Hz is
    Port ( 
            ...
            -- Pino de saída do clock de 10Hz: 1-bit
            -- Descrição: Saída com o sinal de clock com frequência dividida para
            -- 10 Hz, que será usado para a contagem dos décimos de segundo do
            -- cronômetro.
            --
...
--
architecture Behavioral of clk_div_10Hz is
    ...
    -- 
    -- Para 10 Hz e clock padrão de 100 MHz: preset = (10^7)/2 = 5000000
    ...
    --
    constant C_PRESET : std_logic_vector(22 downto 0) := "10011000100101101000000";
    
    -- Sinal s_count que armazena a contagem: 23-bits.
    signal s_count : std_logic_vector (22 downto 0) := (others => '0');
...
begin
    ...
    -- Processo de geração de clock dividido com frequência de 10 Hz
    -- Lista de sensibilidade: clk, rst
    --
    CLK_10HZ_GEN: process(clk, rst)
    begin
